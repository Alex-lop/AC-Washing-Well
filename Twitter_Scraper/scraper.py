...
def scrape_profile_tweets(
    ...
    3. Collect visible tweet articles.
    4. Scroll slowly to load more.
    5. Return raw records for storage/sentiment analysis later.
    """
    ...
    with sync_playwright() as playwright:
        ...
        while should_continue_scrolling(
            ...
            for article in articles:
                tweet = extract_tweet_from_article(article, username)
